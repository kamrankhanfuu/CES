...
export class JobAssign extends React.Component<any> {
  ...
  constructor(props) {
    ...
    this.isRequestor = authStore.currentUser.roles.length === 1 && authStore.currentUser.roles.includes(EROLES.requestor);
  }
    ...
    for (let i = 0; i < 6; i++) {
      ...
      for (let j = 0; j < this.listNameOfDay.length; j++) {
        ...
        if (cell.getMonth() === this.currentDate.getMonth())
          ...
          if (cell.getMonth() > this.currentDate.getMonth() && cell.getFullYear() >= this.currentDate.getFullYear())
            check = true
          calendars.push({
            disable: true
          } as CalendarItem);
                ...
                <div className={`calendar-grid-cell ${isCurrent} ${isStart}`}>
                  {
                    ...
                    <>
                      ...
                      {
                        !this.isRequestor && <div className="calendar-cell-action">
    ...
    return (
      <div className="ce-assign-worker-screen ce-pd-20">
        <div className="ce-calendar ce-calendar-wrapper">
          ...
          {
            !this.isRequestor && <div className="ce-flex-right">
              <div
