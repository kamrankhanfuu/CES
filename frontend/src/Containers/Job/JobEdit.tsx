...
export class JobEdit extends React.Component<any, any> {
  ...
  handleMunicipality(name, value) {
    ...
    this.handleChangeFieldValue('poet', poets.find(poet => poet.label === value.label ).poet);
  }
  ...
  public render() {
    ...
    return (
      <form className="container job-create-page mt-4">
                ...
                <div className="row">
                  ...
                  <div className="form-group col-sm-4">
                    ...
                    <MunicipalitysAsyncSearch
                      ...
                      onSelect={item => this.handleMunicipality('municipality', item)}
                    />
                    <p className="error">
                ...
                <div className="row">
                  ...
                  <div className="form-group col-sm-3">
                    ...
                    <input
                      ...
                      placeholder="00001"
                      // data-type={'number'}
                      value={this.props.values.poet}
                      defaultValue={this.filedValue('poet') ? `${this.filedValue('poet')}` : ''}
                      onChange={this.handleChangeField('poet')}
                    />
                ...
                <div className="row">
                  ...
                  <div className="form-group col-sm-3">
                    ...
                    <input
                      ...
                      placeholder="00001"
                      data-type={'number'}
                      defaultValue={this.filedValue('receipt')}
                      onChange={this.handleChangeField('receipt')}
                    />
                  </div>
                </div>
...
export default withFormik({
  ...
  handleSubmit: async (values: any, { props }) => {
    ...
    jobAPI.update(jobStore.job.id, formatter(values) as any).then(res => {
      if (res.status < 300) {
        values.history.push(`/job/${jobStore.job.id}`);
      }
    });
  }
})(JobEdit);
