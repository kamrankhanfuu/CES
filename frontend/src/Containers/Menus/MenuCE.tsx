        ...
        <div className="menu-web">
          ...
          {authStore.logged && (
            <div className="header-action d-flex align-items-center mr-2">
              ...
              >
                {
                  notificationStore.unReadNotifications.length ? <CeIcon.BellSolidIcon /> : <CeIcon.BellIcon />
                }
              </a>
              {authStore.canAccessRoles() &&
              ...
              {this.toggleNotificationMenu && <NotificationInMenu handleOutSiteClick={this.handleOutSiteClick} />}
              {this.toggleProfile && <ProfileMenu handleLogout={this.handleLogout} />}
            </div>
          )}
        </div>
