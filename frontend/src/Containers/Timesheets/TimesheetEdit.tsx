      ...
      <form onSubmit={this.save} className="container timesheet-create-page">
        ...
        <div className="box-item">
          <div className="box-item-header d-flex align-items-center justify-content-between">
            <div>
              <img className="worker-img  avatar mr-3" src={timesheet.worker.avatar} alt="avatar"/>
            ...
            <div>
              ...
              {authStore.canAccessInvoice() && <span className="mr-3 ">
                <a style={{color: '#3a3c3e'}} href={`/invoices?create=true`}>
            ...
            <div className="row">
              <div className="form-group col-sm-3">
                ...
                <input
                  ...
                  name="section"
                  disabled
                  defaultValue={timesheet.signatureName}
                />
              </div>
              <div className="form-group col-sm-3">
                <label className="d-block" htmlFor="section">
                ...
                <input
                  ...
                  name="section"
                  disabled
                  defaultValue={timesheet.employeeNumber}
                />
              </div>
            </div>
            <div>
