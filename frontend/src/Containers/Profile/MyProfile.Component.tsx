      ...
      <form autoComplete={'off'} className="container" onSubmit={handleSubmit}>
        <div className="form-login form-sign-up m-auto">
          ...
          >
              ...
              {
                  !userStore.me.roles.includes(EROLES.coned_billing_admin)
                  && <div className="notify-item">
                      ...
                      {
                          !userStore.me.roles.includes(EROLES.billing)
                          && <div className="form-group">
                              <CheckboxComponent
                                  id="job_created"
              ...
              }
              {
                  ...
                  && <div className="notify-item">
                      <h4 className="d-flex flex-row justify-content-end">
                          <span className="flex-fill">Worker</span>
                          <span className="mr-4">Email</span>
                          <span >Web/Push</span>
                      </h4>
                      <div className="form-group">
                      ...
                      {
                          !userStore.me.roles.includes(EROLES.requestor)
                          && !userStore.me.roles.includes(EROLES.department_supervisor)
                          && !userStore.me.roles.includes(EROLES.coned_field_supervisor)
                          && <div className="form-group">
                              <CheckboxComponent
            ...
            <div className="notify-item">
                <h4 className="d-flex flex-row justify-content-end">
                    <span className="flex-fill">Invoice</span>
                    <span className="mr-4">Email</span>
                    <span >Web/Push</span>
                </h4>
              <div className="form-group">
